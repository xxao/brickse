...
from . objects import Collection, Theme, Instructions
from . brickse import Brickse


def init(*args):
    """
    Sets API_KEY and USER_TOKEN to be used automatically as defaults for the
    whole brickse module. The API KEY must be available for all the brickse
    ...
    # set API KEY and retrieve USER TOKEN
        ...
        config.USER_TOKEN = data.get('hash', None)
